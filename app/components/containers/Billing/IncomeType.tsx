...
const IncomeType: FC = () => {
  const chartInfo = [
    { label: "Annual Members", value: 20000, color: "#A1EDB0" },
    { label: "Monthly Members", value: 76000, color: "#41BFDD" },
    { label: "Trial Members", value: 4000, color: "#F05E83" },
  ];
  ...
  return (
    <div className="w-full font-jost grid gap-4 bg-black rounded-sm shadow-lg p-6">
      <h2 className="font-medium text-2xl">Income Type</h2>
